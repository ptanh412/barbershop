...
router.get("/me", jwtAuth, asyncHandler(CustomerController.getAuthenticatedUser));
router.put("/update-profile", jwtAuth, asyncHandler(CustomerController.updateProfile));
